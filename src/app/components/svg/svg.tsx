...
export const XIcon = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const NewColumn = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const DarkMode = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const LightMode = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const Settings = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const PenIcon = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const SuccessIcon = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const WarningIcon = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const BinIcon = ({ className }: SVGProps) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
